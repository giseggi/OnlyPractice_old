/*
「問題」
Aさんは最近、砂糖工場で砂糖を配達している。 
Aさんは今、飴屋に砂糖を正確にNキログラム配達しなければならない。 
砂糖工場で作る砂糖は袋に入っている。 
袋は3キログラムの袋と5キログラムの袋がある。
Aさんは面倒だから、極力少ない袋を持って行こうとする。 
例えば、18キログラム砂糖を配達しなければならないとき、3キログラム袋6個を持ち帰ってもいいが、5キログラム3個と3キログラム1個を配達すれば、
さらに少ない個数の袋を配達できる。
